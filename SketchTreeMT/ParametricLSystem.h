...
public:
	...
	String MultiUCT(const String& current_model, const std::vector<cv::Mat>& target, const glm::mat4& mvpMat, int derivation_step);
	void UCT(const String& current_model, const std::vector<cv::Mat>& target, const glm::mat4& mvpMat, int rand_seed, int derivation_step, std::pair<String, double>* best_option);
